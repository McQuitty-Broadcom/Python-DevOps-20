...
- Your login: is mfwsuser20@demo.broadcom.com
...
- Your userid is CUST020.
- Your password CUST020.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS20 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS20 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST020.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST020.MARBLES.JCL(MARBCOPY)" --vasc`
...
Username: _JENKINSCUST020
Password: Mfuser20@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-20.git`
